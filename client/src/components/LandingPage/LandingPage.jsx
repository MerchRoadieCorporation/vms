              ...
              <div className="inner">
                ...
                <ul className="actions special">
                  <form id="title">
                    <label>
                      Email:
                      <input id="InputEmail" style={{ width: 400 }} className="login" type="text" name="email" />
                      <br />
                      Password:
                      <br />
                      <input id="InputPassword" style={{ width: 400 }} className="login" type="password" name="password" />
                    </label >
                      <br />
